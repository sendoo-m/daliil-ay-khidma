...
# Public
router.register(r'governorates', directory.GovernorateViewSet, basename='governorates')  # ✅ مضاف
router.register(r'cities',        directory.CityViewSet,        basename='cities')         # ✅ مضاف
router.register(r'districts',     directory.DistrictViewSet,    basename='districts')      # ✅ مضاف
...
router.register(r'favorites',     directory.FavoriteViewSet,    basename='favorites')      # ✅ مضاف
...
router.register(r'deal-claims',   deals.DealClaimViewSet,       basename='deal-claims')    # ✅ مضاف
...
router.register(r'subscription-plans', subscriptions.SubscriptionPlanViewSet, basename='subscription-plans')  # ✅ مضاف
