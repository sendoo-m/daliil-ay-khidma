...
class BusinessForm(django_forms.ModelForm):
    ...
    class Meta:
        ...
        widgets = {
            ...
            'address_en': django_forms.Textarea(attrs={'class': 'form-control', 'rows': 2}),
            'address_ar': django_forms.Textarea(attrs={'class': 'form-control', 'rows': 2}),
            ...
            'location_url': django_forms.URLInput(attrs={'class': 'form-control'}),
            'latitude': django_forms.NumberInput(attrs={'class': 'form-control', 'step': '0.000001'}),
            'longitude': django_forms.NumberInput(attrs={'class': 'form-control', 'step': '0.000001'}),
            'working_hours_en': django_forms.Textarea(attrs={'class': 'form-control', 'rows': 2}),
            'working_hours_ar': django_forms.Textarea(attrs={'class': 'form-control', 'rows': 2}),
