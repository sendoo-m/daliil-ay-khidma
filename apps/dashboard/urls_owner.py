...
urlpatterns = [
    ...
    path('businesses/create/',               owner.business_create, name='business_create_shop'),
    path('businesses/create/craft/',         owner.business_create, {'business_type': 'craft'}, name='business_create_craft'),
